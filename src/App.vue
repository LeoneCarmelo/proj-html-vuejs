...
<template>
  ...
  <header>
    <div class="container_info d-flex justify-content-between p-2">
      <div class="info">
        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clock-fill me-2"
          viewBox="0 0 16 16">
          <path
      ...
      <div class="contacts">
        ...
        <span class="icons">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-twitter mx-3"
            viewBox="0 0 16 16">
            <path
